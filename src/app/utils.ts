export const MONTHLY_CUSTOMERS_COLLECTION = "monthlyCustomers";
export const CUSTOMERS_COLLECTION = "customers";
export const MONTHLY_STAFFS_COLLECTION = "monthlyStaffs";
export const STAFFS_COLLECTION = "staffs";
export const SERVICE_CATEGORY_COLLECTION = "service-categories";
export const SERVICES_COLLECTION = "services";
export const CUSTOMER_SERVICES_COLLECTION = "cust-services";
export const PACKAGES_COLLECTION = "packages";
export const TRANSACTIONS_COLLECTION = "transactions";
export const SLIDER_IMAGES_COLLECTION = "sliderImages";
...
export const MONTHLY_QUERIES_COLLECTION = "monthlyQueries";
